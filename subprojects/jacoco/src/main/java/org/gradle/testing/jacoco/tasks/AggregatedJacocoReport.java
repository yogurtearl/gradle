...
@Incubating
@CacheableTask
abstract public class AggregatedJacocoReport extends JacocoReport {
        ...
        executionData(getTestCategories().map(categories -> {
            ...
            for (String testCategory : categories) {
                ...
                if (coverageDataPath == null) {
                    ...
                    coverageDataPath.getAttributes().attribute(Attribute.of("testTask", String.class), testCategory);
                }
